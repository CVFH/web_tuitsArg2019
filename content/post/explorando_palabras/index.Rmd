...
```{r elocuencia, warning = FALSE, message = FALSE, dpi = 200}
...
```{r tokenizando, warning = FALSE, message = FALSE, dpi = 200}
...
```{r tokenizando ejemplo, warning = FALSE, message = FALSE, dpi = 200}
...
```{r palabras_tuits, , warning = FALSE, message = FALSE, dpi = 200}
...
```{r nubes por distrito, warning= FALSE, message= FALSE, dpi = 200}
# Nubes de palabras #####
...
```{r tf_idf, message = FALSE, warning = FALSE, dpi = 200}
...
```{r tf_idf gobernador, warning= FALSE, dpi = 200, fig.align = "center"}
...
```{r tf_idf presidente, warning = FALSE, message = FALSE, dpi = 200, fig.align="center"}
plot_presid_tfidf
```
...
```{r hashtags, warning = FALSE, message = FALSE, dpi = 200}
# Hashtags #####
...
```{r hashtags2, warning = FALSE, message = FALSE, dpi = 200}
...
```{r hashtags3, warning = FALSE, message = FALSE, dpi = 200}
