...
De manera provisoria, exploraremos diferentes opciones. Tenemos diferentes vías para arribar a los mismos resultados; básicamente, hemos buscado mantener bases separadas para candidatos a gobernador y a presidente, y hemos aplicado a cada base diferentes tipos de _"tokenización"_.
...
Ya podemos seguir explorando :mag: . Para seguir con la pregunta que nos convocaba, _"¿cuánto hablan nuestros candidatos?"_, podemos diagramar la relación entre las palabras y los tuits emitidos. Graficamos separadamente los candidatos a presidente y a gobernador

```{r palabras_tuits, , warning = FALSE, message = FALSE}
...
```{r nubes por distrito, warning= FALSE, message= FALSE}
# Nubes de palabras #####
...
```{r tf_idf gobernador, warning= FALSE, message= FALSE}
plot_presid_tfidf
```
