...
```{r tf_idf gobernador, warning= FALSE, message= FALSE, out.height=  '100%', out.width = '100%', fig.align = "center"}
...
```{r tf_idf presidente, warning= FALSE, message= FALSE, out.height=  '100%', out.width = '100%', fig.align = "center"}
plot_presid_tfidf
```
