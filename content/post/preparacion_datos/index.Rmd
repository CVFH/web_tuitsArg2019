...
Por ejemplo, para [@alferdez](https://twitter.com/alferdez?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor), utilizamos el comando
...
Por este mismo motivo es que desarrollamos una funcion que agrega y emprolija estos datos en [este script](https://github.com/CVFH/Tuits_arg_2019/blob/master/preparacion_datos_tuits.R) que explicamos en [este post](/preparacion_datos_tuits/), de manera similar a como hicimos con los datos electorales.
